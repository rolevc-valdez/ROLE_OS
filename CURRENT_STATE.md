...
- **Current task:** Phase 2 — Runtime Data Hygiene Bundle (only the Role-approved parts; not started)
- **Last completed task:** Phase 2 — Documentation Reality Sync (see `docs/PHASE_2_DOCUMENTATION_REALITY_SYNC.md`)
